...
BASE_OUT = str(HPC_DIR / "SuStaIn_diag" / "BD" / "folds")
...
print("\n=== STARTE ECHTE 3-FOLD CROSS-VALIDATION (BD) ===")
...
# (Bei BD i.d.R. nur eine Group -> Stratified unnoetig/unsinnig)
# ==========================================================
...
model = ZscoreSustain(
    ...
    dataset_name="SuStaIn_CV_3fold_BD",
...
# ==========================================================
print("\n=== STARTE SuStaIn CROSS-VALIDATION (BD) ===")
...
print("\n=== CV ZUSAMMENFASSUNG (BD) ===")
print(summary)

print("\n[OK] 3-Fold Cross-Validation (BD) abgeschlossen.")
