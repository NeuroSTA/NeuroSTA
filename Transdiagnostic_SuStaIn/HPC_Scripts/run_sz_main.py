...
OUTPUT_MAIN = str(HPC_DIR / "SuStaIn_diag" / "SZ" / "main")
...
if extra_in_zmax:
    print("\nHinweis: Zmax-Datei enthält zusätzliche ROIs, die nicht im SZ-Datensatz vorkommen:")
    print(extra_in_zmax)
...
dataset_name = "SuStaIn_mainRun_SZ"
