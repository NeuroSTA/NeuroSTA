...
My research focuses on the automated analysis of spontaneous speech to identify latent linguistic markers of psychopathology. I investigate latent linguistic parameters in affective and psychotic disorders using automated speech analysis, structural MRI, diffusion MRI, and advanced statistical and machine-learning approaches.

<section class="section" id="research">
  <div class="title">🧪 Research</div>
  <p class="desc">
    Computational psychiatry · Natural language processing · Automatic speech analysis · Formal thought disorder · Transdiagnostic psychopathology · Structural and diffusion MRI · Machine learning
  </p>
</section>
...
<section class="section" id="publications">
  ...
  <ul class="pubs">
    ...
    <li>
      Mülfarth, R. R., <span class="me">Seuffert, S.</span>, Alexander, N., Jamalabadi, H., Nenadić, I., Straube, B., Teutenberg, L., Thomas-Odenthal, F., Usemann, P., Dannlowski, U., Kircher, T., &amp; Stein, F. (2026).
    ...
    <li>
    <span class="me">Seuffert, S.</span>, Mülfarth, R. R., Teutenberg, L., Thomas-Odenthal, F., Usemann, P., Alexander, N., Jamalabadi, H., Nenadić, I., Straube, B., Hahn, T., Dannlowski, U., Kircher, T., &amp; Stein, F. (2025).
    ...
    <li>
      Palominos, C., He, R., Fröhlich, K., Mülfarth, R. R., <span class="me">Seuffert, S.</span>, Sommer, I. E., Homan, P., Kircher, T., Stein, F., &amp; Hinzen, W. (2024).
